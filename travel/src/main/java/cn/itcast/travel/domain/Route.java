...
public class Route implements Serializable {
    ...
    public Route(int rid, String rname, double price, String routeIntroduce, String rflag, String rdate, String isThemeTour, int count, int cid, String rimage, int sid, String sourceId, String cname, Category category, Seller seller, List<RouteImg> routeImgList) {
